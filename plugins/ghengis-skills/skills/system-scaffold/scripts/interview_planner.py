    ...
    batches.append(
        {
            ...
            "description": "Declare any personal categories beyond the built-in taxonomy (e.g., 'example-client' for law firm work, 'knowstudio' for company projects, 'virgil-videos' for active video editing series).",
