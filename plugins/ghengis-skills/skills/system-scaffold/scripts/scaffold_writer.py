...
- Custom-category roots from taxonomy.yaml (Y:\\example-client, Y:\\knowstudio, etc.)
...
def render_folder_context(node: dict, drives_cfg: dict, taxonomy: dict, child_nodes: list[dict]) -> str:
    ...
    descriptions = {
        ...
        "example-client": "example-client client work. Drive I is untouched-by-default.",
    }
