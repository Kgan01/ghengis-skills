---
name: pql-validation
description: Use when writing, reviewing, or improving prompts for agents, subagents, or LLM calls â€” detects anti-patterns, suggests fixes, and enforces prompt quality principles
---
