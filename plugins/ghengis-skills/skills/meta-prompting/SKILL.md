...
- You already have the context â€” delegating forces you to re-explain what you already know
...
- Creating a validator for a 10-line change â€” just run the tests yourself
- Writing a 200-token meta-prompt for a 50-token task
- Subagents spawning their own subagents (decomposition is wrong â€” flatten it)
